...
import apiModalConfig from '../../vendor/api-connector/mixins/apiModalConfig';
  ...
  methods: {
    mountWhenTranslationAvailable() {
      ...
      if(ProcessMaker.i18n.exists('Save') === false) {
        ...
        that.apiConfiguration = that.screen.api_config ? that.screen.api_config : [];
        that.previewInput = "{}";
