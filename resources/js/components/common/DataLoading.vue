...
<script>
    export default {
        ...
        methods: {
            ...
            descText() {
                return this.desc ? this.desc: 'Please wait while your content is loaded'
            },
            emptyText() {
                return this.empty? this.empty: 'No Results'
            },
            emptyDescText() {
            ...
            errorTitleText() {
                return 'Sorry! API failed to load'
            },
            errorDescText() {
                return 'Something went wrong. Try refreshing the application'
            }
        },
    }
</script>
